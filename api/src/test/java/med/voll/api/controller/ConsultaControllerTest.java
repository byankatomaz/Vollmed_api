...
class ConsultaControllerTest {
    ...
    void agendar_cenario2() throws Exception {
        ...
        var dadosDetalhamentoMock = new DadosDetalhamentoConsulta(null, 2L, 2L, data);

        when(agendaDeConsultas.agendar(any())).thenReturn(dadosDetalhamentoMock);
